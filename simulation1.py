...
def genweights(floors):
    ...
    morgon = [weights1.copy(), weights2.copy()]
    morgon[0][0] = 15
    for i in range(1, floors):
        morgon[1][i][0] = 5

    efter = [weights1.copy(), weights2.copy()]
    efter[0][0] = 5
    for i in range(1, floors):
        efter[1][i][0] = 10
...
def stupidsim(peoples, pepm):
    #generera vikter, kommer ändras senare
    floors = 10
    door_time = 15
   # peoples = 5000
    people_per_minute = pepm
...
def mediumsim(peoples, rounds, pepm):
...
def smartsim(peoples, rounds, pepm):
...
ans = (stupidsim(1000, 4.0), mediumsim(1000, 40000, 4.0), smartsim(1000, 40000, 4.0)) 
print(ans)
